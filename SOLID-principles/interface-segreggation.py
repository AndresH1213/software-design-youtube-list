"""
Interface segregation means that overall it's better if you have
several specific interfaces as opposed to one general purpose
interface
"""
...
authorizer = SMSAuth()
processor = DebitPaymentProcessor("212313", authorizer)
authorizer.verify(23109)
processor.pay(order)