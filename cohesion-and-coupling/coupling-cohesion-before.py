...
class Application:
#NOTE: register vehicule is doing a lot of things low cohesion
    def register_vehicle(self, brand: string):
        # create a registry instance
        registry = VehicleRegistry()
#NOTE: it relays in the implementation of VehicleRegistry class, that means
#       if we change something in the class we also need to change register_vehicle
